...
typedef uint32_t (*SubGhzGetHashDataLong)(void* decoder); /* ARF: wider hash for Keeloq */
...
typedef struct {
    ...
    SubGhzGetHashDataLong get_hash_data_long; /* ARF extension; NULL in stock protocols */
    SubGhzGetString get_string;
    SubGhzGetString get_string_brief;         /* ARF extension; NULL in stock protocols */
